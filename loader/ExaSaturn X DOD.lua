...
local devInfo = loadstring(game:HttpGet("https://raw.githubusercontent.com/HS1HYDRAX7/45786153617475726E/refs/heads/main/path/devs.luau"))()
...
AtlasDev = CreditsTab:Paragraph({
    Title = "" .. devInfo.devs.atlasDev.Display .. " (" .. devInfo.devs.atlasDev.User .. ")",
    Desc = "" .. devInfo.devs.atlasDev.Role .. "",
